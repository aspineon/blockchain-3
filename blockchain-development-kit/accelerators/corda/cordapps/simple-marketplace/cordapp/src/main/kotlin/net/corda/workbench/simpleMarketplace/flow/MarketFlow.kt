...
@InitiatingFlow
@StartableByRPC
class MarketFlow (val item: AvailableItem,
                  val offeredPrice : Double,
                  val otherParty: Party)
                        : FlowLogic<SignedTransaction>() {

    override val progressTracker = MarketFlow.tracker()
    ...
    override fun call(): SignedTransaction {
        ...
        val _accepted = AcceptedState(serviceHub.myInfo.legalIdentities.first(), otherParty, item, offeredPrice)
